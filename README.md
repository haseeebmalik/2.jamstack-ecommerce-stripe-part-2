...
ever we want.In webhook we give the the url of our netlify function,to get response .You may go to netlify functions in gui and see what the response is.**
